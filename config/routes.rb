Rails.application.routes.draw do
  ...
  get '/pmu_alr/race_details' => 'pmu_alr#race_details', as: :pmu_alr_race_details
  ...
  get '/ussd_testing/start_ussd_log' => 'ussd_testing#start_ussd_log'
  ...
  post '/mtn/ussd/main_menu' => 'ussd_testing#main_menu'
